...
const WordClouds = () => {
  return (
    ...
    >
      <p style={{ top: 50, left: '100%', fontSize: 23 }}>Javascript</p>
      <p style={{ top: 0, left: 0, fontSize: 18 }}>Azure Devops</p>
      <p style={{ top: 200, left: -60, fontSize: 14 }}>Database Design</p>
      <p style={{ top: '30%', left: '35%', fontSize: 25 }}>MS Test</p>
      <p style={{ top: 40, left: '75%', fontSize: 12 }}>SSAS</p>
      <p style={{ top: 380, left: '85%', fontSize: 18 }}>WCF</p>
      <p style={{ top: 320, left: '65%', fontSize: 18 }}>Durandal</p>
